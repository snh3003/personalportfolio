...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Developer 🚀 having an experience of building Web and Mobile applications with Reactjs / Angular / Nodejs / React Native, also a Cloud Enthusiast."
  ),
  resumeLink:
